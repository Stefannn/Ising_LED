...
public:
    TestModel () {
        std::cout << "TestModel default constructor\n";
    }
    void update_model(Sim::Lattice<> & l) {
        std::cout << "testmodel update_model\n";
    }
};
...
public:
    TestView() {
        std::cout << "Testview default const\n";
    }
    void update_view(const Sim::Lattice<> & l) {
        /*std::cout <<"testview update_view\n";*/
    }
};
